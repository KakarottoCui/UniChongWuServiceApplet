	...
	<view >
		...
		<view class="pet-wrap u-p-20">
			...
			<u-cell-group title="服务列表">
				<u-cell-item @click="getInfo(item)" v-for="(item,index) in items" :key="index" icon="setting-fill" :title="item.title" :label="item.orderTime" value="详情" :arrow="true"></u-cell-item>
			</u-cell-group>
