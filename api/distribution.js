...
const withdrawConfig =
	'/tiny-distribution/v1/promoter-commission-withdraw/config';
// 提现申请
const withdrawCreate =
	'/tiny-distribution/v1/promoter-commission-withdraw/create';
// 提现申请列表
...
// 区域代理
// 申请进度
const regionalAgentApplySchedule =
	'/tiny-distribution/v1/regional-agent-apply/index';
// 申请配置
...
// 自推订单统计
const promoterRecordSelfStat =
	'/tiny-distribution/v1/promoter-record/self-stat';
// 团队订单
const promoterRecordTeam = '/tiny-distribution/v1/promoter-record/team';
// 团队订单统计
const promoterRecordTeamStat =
	'/tiny-distribution/v1/promoter-record/team-stat';

// 团队订单统计
const memberQrCode =
	'/tiny-distribution/v1/member/qr-code';

// 提现银行卡
const bankNumberIndex =
	'/tiny-distribution/v1/bank-number/index';
